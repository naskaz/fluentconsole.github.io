...
namespace Test5_PositiveMixedDecimals
{
  class Test5_PositiveMixedDecimals
  {
    static void Main(string[] args)
    {
      Console.WriteLine("TEST 5: POSITIVE MIXED DECIMALS (varying decimal places)");
      Console.WriteLine("========================================================\n");

      var sorter = new HumanSort();
      var data = new List<string>
            {
                "100.5", "25.25", "50.75", "0.001", "1.123", "999.99", "42.42", "7.777", "1000.001", "500.555"
            };
      ...
      DisplayList(asc);
      ValidateOrder(asc, true, "Positive mixed decimals ascending");

      Console.WriteLine("\nDescending Sort:");
      var desc = sorter.Sort(data, HumanSort.ColumnType.Number, false, HumanSort.NullHandling.NullsFirst, out _);
      DisplayList(desc);
      ValidateOrder(desc, false, "Positive mixed decimals descending");
