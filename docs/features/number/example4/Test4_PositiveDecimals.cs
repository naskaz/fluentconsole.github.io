...
namespace Test4_PositiveDecimals
{
  class Test4_PositiveDecimals
  {
    static void Main(string[] args)
    {
      Console.WriteLine("TEST 4: POSITIVE DECIMALS (1 decimal place)");
      Console.WriteLine("============================================\n");

      var sorter = new HumanSort();
      var data = new List<string>
            {
                "100.5", "25.2", "50.7", "0.0", "1.1", "999.9", "42.4", "7.7", "1000.0", "500.5"
            };
      ...
      DisplayList(asc);
      ValidateOrder(asc, true, "Positive decimals ascending");

      Console.WriteLine("\nDescending Sort:");
      var desc = sorter.Sort(data, HumanSort.ColumnType.Number, false, HumanSort.NullHandling.NullsFirst, out _);
      DisplayList(desc);
      ValidateOrder(desc, false, "Positive decimals descending");
