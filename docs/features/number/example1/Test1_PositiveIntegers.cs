...
namespace Test1_PositiveIntegers
{
  class Test1_PositiveIntegers
  {
    static void Main(string[] args)
    {
      Console.WriteLine("TEST 1: POSITIVE INTEGERS");
      Console.WriteLine("==========================\n");
      ...
      DisplayList(asc);
      ValidateOrder(asc, true, "Positive integers ascending");

      Console.WriteLine("\nDescending Sort:");
      var desc = sorter.Sort(data, HumanSort.ColumnType.Number, false, HumanSort.NullHandling.NullsFirst, out _);
      DisplayList(desc);
      ValidateOrder(desc, false, "Positive integers descending");
