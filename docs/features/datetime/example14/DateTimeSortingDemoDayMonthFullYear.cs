namespace DateTimeSortingDemoDayMonthFullYear
{
	class DateTimeSortingDemoDayMonthFullYear
	{
		static void Main(string[] args)
		{
			Console.WriteLine("DATE TIME SORTING DEMONSTRATION (Day Month Full Year Format: dd MMMM yyyy)");
			Console.WriteLine("==================================================================================\n");

			var sorter = new HumanSort();
			var culture = new CultureInfo("en-GB"); // Using GB culture for day-first parsing

			// Test data with day full month name year format (dd MMMM yyyy)
			var data = new List<string>
						{
								"07 April 2023",   // 7 April 2023
                "06 May 2023",     // 6 May 2023
                "12 January 2024", // 12 January 2024
                "08 July 2022",    // 8 July 2022
                "03 February 2025", // 3 February 2025
                ...
                "01 October 2023", // 1 October 2023
                "19 June 2024",    // 19 June 2024
                "05 September 2022", // 5 September 2022
            };

			Console.WriteLine($"Input Data ({data.Count} items, format: dd MMMM yyyy):");
			Console.WriteLine("================================================================================");
			Console.WriteLine("Note: en-GB culture interprets as day full month name year (dd MMMM yyyy)");
			Console.WriteLine();
